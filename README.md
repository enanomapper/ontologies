...
The specific slimming steps can be consulted in the [slimming script](https://github.com/jmillanacosta/ontologies/blob/master/scripts/src/build-workflow/slim-ncit.sh) used in the workflow.
