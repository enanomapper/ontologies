...
## Lifecycle
echo NMLCO
cp internal-dev/nmlco.owl internal-dev/nmlco.owl

## Regulation
echo Wikidata
cp internal-dev/wikidata.owl internal-dev/wikidata.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/assays_methods.owl" \
        --output internal-dev/assays_methods.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/endpoints.owl" \
        --output internal-dev/endpoints.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/biological_processes.owl" \
        --output internal-dev/biological_processes.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/biological_entities.owl" \
        --output internal-dev/biological_entities.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/qualities_dispositions.owl" \
        --output internal-dev/qualities_dispositions.owl
...
sh robot \
    filter \
        --input enanomapper-all.owl \
        --term obo:UO_0000000 \
        --term "http://purl.enanomapper.net/onto/ENM_6804785" \
        --select "annotations self descendants" \
        --trim false \
        --signature false \
    unmerge \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/units.owl" \
        --output internal-dev/units.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/chemicals_materials.owl" \
        --output internal-dev/chemicals_materials.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/descriptors.owl" \
        --output internal-dev/descriptors.owl
...
sh robot \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/information_content_entity.owl" \
        --output internal-dev/information_content_entity.owl
sh robot \
    unmerge \
        --input internal-dev/information_content_entity.owl \
        --input internal-dev/assays_methods.owl \
        --output internal-dev/information_content_entity.owl
# Instruments
sh robot \
    filter \
    ...
    annotate \
        ...
        --version-iri "http://enanomapper.github.io/ontologies/releases/11.0/internal/instrument.owl" \
        --output internal-dev/instrument.owl    

rm internal-dev/*int.owl