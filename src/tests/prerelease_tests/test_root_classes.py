...
class RobotTest(unittest.TestCase):
    ...
    def test_query_results(self):
        ...
        subprocess.run(["sh", "robot", "query", "--input", "enanomapper-full.owl", "--query", "src//tests/assets/test_root.sparql", "result-root"])
        subprocess.run(["sh", "robot", "query", "--input", "enanomapper-full.owl", "--query", "src//tests/assets/test_entities.sparql", "result-entities"])
